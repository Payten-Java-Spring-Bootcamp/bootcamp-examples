INSERT INTO movie(id, status, name, genre, release_year, director)
VALUES (1001, 'ACTIVE', 'test film 1001', 'COMEDY', 2001, 'test yönetmen 1001'),
       (1002, 'ACTIVE', 'test film 1002', 'COMEDY', 2002, 'test yönetmen 1002');
